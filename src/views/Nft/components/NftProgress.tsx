...
import { Card, CardBody, Heading, OpenNewIcon, Text, Link as UIKitLink, Progress } from '@zoomswap-libs/uikit'
        ...
        <InfoRow>
          ...
          <div>
            {!isInitialized ? (
              ...
              <Link href={`https://iotexscan.io/block/${endBlockNumber}`} target="_blank" rel="noreferrer noopener">
