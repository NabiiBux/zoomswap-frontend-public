...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from '@zoomswap-libs/uikit'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="https://exchange.zoomswap.io/#/swap" mr="16px">
              {TranslateString(999, 'Buy cake')}
            </LinkExternal>
            <LinkExternal href="https://exchange.zoomswap.io/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
          ...
          <Text as="div" pt="16px">
            <Button
              as="a"
              variant="secondary"
              href="https://docs.exchange.zoomswap.io/core-products/ifo-initial-farm-offering"
            >
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with PancakeSwap, IoTeX Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on IoTeX.',
              )}
            </Text>
            <Button
              as="a"
