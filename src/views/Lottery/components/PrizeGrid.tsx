...
import { Heading, Text } from '@zoomswap-libs/uikit'
...
const PrizeGrid: React.FC<PrizeGridProps> = ({
  ...
  const fourMatchesAmount = +((lotteryPrizeAmount / 100) * 60).toFixed(1)
  const threeMatchesAmount = +((lotteryPrizeAmount / 100) * 25).toFixed(1)
  const twoMatchesAmount = +((lotteryPrizeAmount / 100) * 14).toFixed(1)
  const burnAmount = +((lotteryPrizeAmount / 100) * 1).toFixed(1)
