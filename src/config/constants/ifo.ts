...
const ifos: Ifo[] = [
  {
    ...
    isActive: false,
    name: 'BLINk (BLK)',
    subTitle: 'Online games on IoTeX',
    description:
  ...
  },
  {
    ...
    description:
      'Ditto is the first elastic supply token on the IoTeX Chain. Its goal is to maintain a stable price of $1, where its supply will adapt to changes in demand. All supply changes will apply equally to every wallet holding Ditto, and holders should always have the same % of the total supply',
    launchDate: 'Dec. 23',
    launchTime: '3PM SGT',
  ...
  },
  {
    ...
    description:
      'Helmet is a peer-to-peer insurance protocol written with options trading logic, which allows anyone to create any insurance policy easily in the market. Helmet aims to enable DeFi users to be protected against the risk of price fluctuations by providing price-shield insurance for IoTeX assets. They provide suppliers with a range of insurance types to sell, giving a variety of hedging strategies to the market.',
    launchDate: 'Jan. 13',
    launchTime: '5PM SGT',
  ...
  },
  {
    ...
    isActive: true,
    name: 'Soteria',
    subTitle: 'A blockchain based mutual to share the risk of DeFi on IoTeX Chain',
    description:
